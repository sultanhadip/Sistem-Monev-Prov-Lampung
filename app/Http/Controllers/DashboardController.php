...
class DashboardController extends Controller
{
    ...
    public function getFilteredData(Request $request)
    {
        ...
        if (! $kodeKegiatan || ! $waktuKegiatan) {
            return response()->json('Lengkapi input pada filter', 400);
        }
        ...
        if (! $startDate || ! $endDate) {
            return response()->json('Format periode tidak valid', 400);
        }
        ...
        try {
            ...
            return response()->json('Tidak ada data untuk periode tersebut', 404);
        }
    }
}
