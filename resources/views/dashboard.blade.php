        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row text-center">
              ...
              <div class="col-lg-12">
                <div class="card rounded-4">
                  <div class="card-body" id="realisasi-card-body">
                    <h5 class="card-title">Realisasi Pencacahan Menurut Satuan Kerja</h5>

                    <p id="no-kegiatan-message" class="text-center text-muted">Tidak ada kegiatan yang dipilih</p>
                      ...
                      $('#btn-tampilkan').click(function() {
                        ...
                        $.ajax({
                          ...
                          success: function(response) {
                            ...
                            // Show the card and chart
                            $('#realisasi-card-body').fadeIn(); // Menggunakan fadeIn untuk menampilkan secara halus
                            $('#chartLegend').removeClass('d-none'); // Menampilkan legend setelah chart ditampilkan
                          },
                          error: function(xhr) {
      ...
      $('#btn-tampilkan').click(function() {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            // Tampilkan card realisasi
            $('#realisasi-card-body').fadeIn(); // Menampilkan bagian realisasi dengan animasi

            // Hide the "Tidak ada kegiatan yang dipilih" message after clicking "Tampilkan"
            $('#no-kegiatan-message').hide();
          },
          error: function(xhr) {
            alert('Terjadi kesalahan saat mengambil data: ' + xhr.responseText);
          },
