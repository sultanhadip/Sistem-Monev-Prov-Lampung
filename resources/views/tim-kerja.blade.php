...
<body>
            ...
            <di class="card-body">
              ...
              <div class="d-flex gap-3 mb-3">
                <input type="text" class="form-control w-25" id="searchInput"
                  placeholder="Cari Tim Kerja" value="{{ request('search') }}">
              </div>
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center ms-auto">
                  ...
                  <div id="paginationContainer">
                    @include('timkerja.pagination', ['timkerja' => $timkerja])
                  </div>
                </div>
  ...
  <script>
    $('#editModal').on('show.bs.modal', function(event) {
      ...
      var nama_tim = button.data('nama_tim');

      // Set form action URL
      var formAction = '{{ route("timkerja.update", ":id") }}';
      formAction = formAction.replace(':id', id);
      modal.find('form').attr('action', formAction);

      // Isi field dengan data yang dipilih
      modal.find('#nama_tim').val(nama_tim);
    });
  </script>
  ...
  <script>
    // Mengambil data-url dari tombol hapus
  ...
  <!-- 4. Komponen JS tambahan jika dipakai -->
